                    ...
                    <div class="row">
                        ...
                        <div class="col s12 m6 offset-m2">
                            ...
                            <div class="row">
                                <div class="col s8 m8">
                                    <a href="#" class="button">
                                        <div class="call-to-action center-align">
                                            Essayez OptiMiam !
                                        </div>
                                    </a>
                                    <div class="sub-txt">
            ...
            <section class="explanation">
                ...
                <div class="row food-wasted">
                    <div class="col s12 m6 offset-m3 center-align">
                        <p class="subtitle">
                            Estimer les quantités de produits qui vont être écoulées chaque jour est une tache difficile. 
                        </p>
                        <p class="text">
                            C’est l'une des raisons pour lesquelles des tonnes de nourriture sont gaspillées chaque année. OptiMiam vous offre l’opportunité de vendre à temps ces produits destinés à être gaspillés !
                        </p>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col s12 center-align-on-med">
                        ...
                        <div class="col s12 pull-m6 m6">
                            ...
                            <p class="exemple-text">
                                Pour une flexibilité maximale, vous décidez quand les clients peuvent venir chercher les produits qu'ils ont achetés. Tous les paiements sont gérés en toute sécurité via l'application et vous obtenez des paiements mensuels. Les statistiques de vente sont toujours disponibles dans l'application pour que vous puissiez les suivre en temps réel.
                            </p>
                            <a href="#"><div class="end-explanation button">Essayer OptiMiam !</div></a>
                            <div class="sub-button">Gratuit et sans obligation</div>
                        </div>
                    </div>
                </div>
            </section>
                        ...
                        <div class="col s12 m5 offset-m1 comments-content">
                            ...
                            <div class="row">
                                <div class="col s12 m12 center-align">
                                    <a href="#"><div class="button">Devenez commerçant</div></a>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col s12 m12 center-align">
                                    <div class="sub-txt">Gratuit et sans obligation</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col s12 center-align-on-med">
                        ...
                        <div class="col s12 pull-m6 m6">
                            ...
                            <p class="exemple-text">
                                En utilisant l'application OptiMiam, votre restaurant transforme facilement les excédents en revenus tout en atteignant de nouveaux clients qui vous découvrent grâce à la carte présente sur l’application OptiMiam.
                            </p>
                            <a href="#"><div class="button">Inscrivez votre restaurant</div></a>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col s12 center-align-on-med">
                        ...
                        <div class="col s12 push-m0 m6">
                            ...
                            <a href="#"><div class="button">Inscrivez votre épicerie</div></a>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col s12 center-align-on-med">
                        ...
                        <div class="col s12 pull-m6 m6">
                            ...
                            <p class="exemple-text">
                                En fin de journée il vous reste du pain frais qu’il vous fait mal au cœur de jeter ? Avec OptiMiam, il est facile de donner une seconde chance à vos produits de qualité au lieu de les jeter !
                            </p>
                            <a href="#"><div class="button"><span>Inscrivez votre café ou votre boulangerie</span></div></a>
                        </div>
                    </div>
                </div>
            </section>
